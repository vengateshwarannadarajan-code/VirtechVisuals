    ...
    <div className="min-h-screen bg-[#1a1a1a] text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-8 w-full max-w-4xl mx-auto pt-16">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="flex flex-col gap-[12px] justify-center items-center mb-6 w-full">
            <Link to="/smart-factory" className="w-full max-w-[320px] px-8 py-4 bg-[#d4af37] text-[#1a1a1a] rounded-lg hover:bg-[#f5f5f5] transition-all duration-300 flex items-center justify-center gap-2">
              {t('home.cta.factory')} <ArrowRight className="w-4 h-4" />
            </Link>
            <Link to="/creative-studio" className="w-full max-w-[320px] px-8 py-4 border border-white/20 text-white rounded-lg hover:border-[#d4af37]/60 hover:text-[#d4af37] transition-all duration-300 flex items-center justify-center gap-2">
