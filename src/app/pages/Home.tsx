...
const pillars = [
  {
    ...
    label: 'Smart Factory',
    to: '/smart-factory',
    desc: 'Industry 4.0 automation & IIoT',
  },
  {
    icon: <Layers className="w-6 h-6 text-[#d4af37]" />,
    label: 'Products',
    to: '/products',
    desc: 'Edge hardware & software platforms',
  },
  {
    icon: <TrendingUp className="w-6 h-6 text-[#d4af37]" />,
    label: 'Services',
    to: '/services',
    desc: 'Consulting, deployment & support',
  },
  {
    icon: <Brain className="w-6 h-6 text-[#d4af37]" />,
    label: 'AI',
    to: '/ai',
    desc: 'Applied ML for industrial operations',
  },
  {
    icon: <Users className="w-6 h-6 text-[#d4af37]" />,
    label: 'Case Studies',
    to: '/case-studies',
    desc: 'Real outcomes from real deployments',
  },
  {
    icon: <Camera className="w-6 h-6 text-[#d4af37]" />,
    label: 'Creative Studio',
    to: '/creative-studio',
    desc: 'Photography, video & social content',
  },
];
...
const solutions = [
  {
    ...
    desc: 'Improve OEE/OLE and delivery with real-time control and smart scheduling.',
    to: '/smart-factory',
  },
  {
    icon: <ShieldCheck className="w-6 h-6 text-[#d4af37]" />,
    title: 'Quality & Traceability',
    desc: 'Reduce defects and speed audits with digital QC, vision, and genealogy.',
    to: '/smart-factory',
  },
  {
    icon: <Wrench className="w-6 h-6 text-[#d4af37]" />,
    title: 'Maintenance Intelligence',
    desc: 'Cut breakdowns using structured PM, work orders, and reliability KPIs.',
    to: '/smart-factory',
  },
  {
    icon: <Package className="w-6 h-6 text-[#d4af37]" />,
    title: 'Warehouse & Intralogistics',
    desc: 'Increase inventory accuracy and dispatch speed with disciplined workflows.',
    to: '/smart-factory',
  },
  {
    icon: <Eye className="w-6 h-6 text-[#d4af37]" />,
    title: 'Spatial & Vision Intelligence',
    desc: 'Track assets and verify quality/safety using location tech and AI cameras.',
    to: '/smart-factory',
  },
  {
    icon: <GitBranch className="w-6 h-6 text-[#d4af37]" />,
    title: 'Digital Twin & Robotics Enablement',
    desc: 'Simulate, automate, and scale smarter movement with digital twins and robots.',
    to: '/smart-factory',
  },
];
...
const services = [
  {
    ...
    desc: 'Web apps, mobile apps, enterprise software, APIs, and SaaS products built for your business.',
    to: '/services',
  },
  {
    icon: <UserCheck className="w-6 h-6 text-[#d4af37]" />,
    title: 'Talent Solutions',
    desc: 'Permanent recruitment, contract staffing, executive search, and project-based hiring.',
    to: '/services',
  },
  {
    icon: <Brain className="w-6 h-6 text-[#d4af37]" />,
    title: 'Artificial Intelligence',
    desc: 'Computer vision, predictive analytics, NLP, anomaly detection, and AI integration.',
    to: '/ai',
  },
  {
    icon: <Cloud className="w-6 h-6 text-[#d4af37]" />,
    title: 'Cloud & DevOps Services',
    desc: 'Cloud architecture, migration, CI/CD, Kubernetes, monitoring, and cost optimization.',
    to: '/services',
  },
  {
    icon: <Wifi className="w-6 h-6 text-[#d4af37]" />,
    title: 'IoT & Edge Computing',
    desc: 'PLC/SCADA connectivity, edge gateways, BLE/LoRaWAN, and edge AI deployment.',
    to: '/services',
  },
  {
    icon: <Lock className="w-6 h-6 text-[#d4af37]" />,
    title: 'Cybersecurity',
    desc: 'VAPT, security audits, OT/ICS security, SOC/SIEM monitoring, and privacy compliance.',
    to: '/services',
  },
];
...
const products = [
  {
    icon: <DoorOpen className="w-6 h-6 text-[#d4af37]" />,
    name: 'GateKeeper',
    tagline: 'Visitor Management',
    desc: 'Visitor management system with pre-registration, badge printing, and real-time tracking.',
    to: '/products',
  },
  {
    icon: <MessageSquare className="w-6 h-6 text-[#d4af37]" />,
    name: 'IncidentGPT',
    tagline: 'AI Incident Reporting',
    desc: 'AI-powered incident reporting and root cause analysis with natural language processing.',
    to: '/products',
  },
  {
    icon: <Eye className="w-6 h-6 text-[#d4af37]" />,
    name: 'VisionSafe AI',
    tagline: 'Safety Analytics',
    desc: 'AI-powered safety analytics with computer vision for PPE detection and hazard monitoring.',
    to: '/products',
  },
  {
    icon: <MapPin className="w-6 h-6 text-[#d4af37]" />,
    name: 'DigiTrack',
    tagline: 'Asset & Inventory Visibility',
    desc: 'Real-time asset & inventory visibility with BLE, UWB, GPS, and LoRaWAN tracking.',
    to: '/products',
  },
  {
    ...
    desc: 'Digital permit-to-work management with safety checklists, approvals, and compliance tracking.',
    to: '/products',
  },
  {
    ...
    desc: 'Predictive maintenance with vibration analysis, thermal monitoring, and failure prediction.',
    to: '/products',
  },
];
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 flex">
          <div className="w-1/2 overflow-hidden">
            <img
              src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=960"
              alt="Industrial"
          ...
          <div className="w-1/2 overflow-hidden">
            <img
              src="https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=960"
              alt="Creative"
              className="w-full h-full object-cover scale-110"
            />
          </div>
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto pt-16">
          <motion.span
            ...
            className="inline-block px-4 py-1.5 rounded-full border border-[#d4af37]/40 text-[#d4af37] text-xs tracking-widest uppercase mb-8"
          >
          ...
          >
            <Link
              to="/smart-factory"
              className="px-8 py-4 bg-[#d4af37] text-[#1a1a1a] rounded-lg hover:bg-[#f5f5f5] transition-all duration-300 flex items-center justify-center gap-2"
            >
              Explore Digi Sailor <ArrowRight className="w-4 h-4" />
            </Link>
            <Link
              to="/creative-studio"
              className="px-8 py-4 border border-white/20 text-white rounded-lg hover:border-[#d4af37]/60 hover:text-[#d4af37] transition-all duration-300 flex items-center justify-center gap-2"
            >
        ...
        {highlights.map((h, i) => (
          ...
          >
            ...
            <div className="bg-[#222] p-10 md:p-14 flex flex-col justify-center">
              ...
              <Link
                to={h.to}
                className="inline-flex items-center gap-2 text-[#d4af37] hover:text-white transition-colors group/link"
              >
                {h.cta}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div>
              ...
              <p className="text-[#a0a0a0] mt-4 max-w-2xl text-sm leading-relaxed">
                24 solutions across shopfloor operations, enterprise functions, and corporate governance — built to scale from pilot to multi-plant.
              </p>
            </div>
            <Link
              to="/smart-factory"
              className="inline-flex items-center gap-2 text-sm text-[#d4af37] border border-[#d4af37]/30 px-5 py-2.5 rounded-lg hover:bg-[#d4af37]/10 transition-colors whitespace-nowrap flex-shrink-0"
            >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div>
              ...
              <p className="text-[#a0a0a0] mt-4 max-w-2xl text-sm leading-relaxed">
                12 service lines covering every stage of your digital transformation — from custom development to cybersecurity.
              </p>
            </div>
            <Link
              to="/services"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {services.map((s, i) => (
              ...
              >
                <Link
                  to={s.to}
                  className="group flex items-start gap-5 p-7 bg-[#222] border border-[#2e2e2e] rounded-xl hover:border-[#d4af37]/40 hover:bg-[#252525] transition-all duration-300"
                >
                  ...
                  <div>
                    ...
                    <div className="mt-3 flex items-center gap-1 text-xs text-[#555] group-hover:text-[#d4af37] transition-colors">
                      Explore Service <ArrowRight className="w-3 h-3 transition-transform group-hover:translate-x-0.5" />
                    </div>
                  </div>
                </Link>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div>
              ...
              <p className="text-[#a0a0a0] mt-4 max-w-2xl text-sm leading-relaxed">
                Purpose-built software for visitor management, safety, asset tracking, predictive maintenance, and more.
              </p>
            </div>
            <Link
              to="/products"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {products.map((p, i) => (
              ...
              >
                <Link
                  to={p.to}
                  className="group flex flex-col gap-5 p-7 bg-[#1a1a1a] border border-[#2e2e2e] rounded-xl hover:border-[#d4af37]/40 hover:bg-[#1e1e1e] transition-all duration-300 h-full"
                >
                  <div className="flex items-center justify-between">
                    <div className="p-2.5 bg-[#d4af37]/10 rounded-lg group-hover:bg-[#d4af37]/20 transition-colors">
                      {p.icon}
                    </div>
                    <span className="text-[10px] text-[#555] tracking-widest uppercase border border-[#2e2e2e] px-2.5 py-1 rounded-full group-hover:border-[#d4af37]/30 group-hover:text-[#d4af37]/70 transition-colors">
                      {p.tagline}
                    </span>
                  </div>
                  <div>
                  ...
                  <div className="mt-auto flex items-center gap-1 text-xs text-[#555] group-hover:text-[#d4af37] transition-colors">
                    Explore Product <ArrowRight className="w-3 h-3 transition-transform group-hover:translate-x-0.5" />
                  </div>
                </Link>
              </motion.div>
            ))}
            ...
            {[
              {
                ...
                label: '24 Smart Factory Solutions',
                body: 'From OEE & quality to warehouse, safety, and digital twins — one platform covering shopfloor to boardroom.',
              },
              {
                icon: <Layers className="w-5 h-5 text-[#d4af37]" />,
                label: '12 Technology Services',
                body: 'Custom software, cloud & DevOps, cybersecurity, IoT, talent solutions, and training — end-to-end delivery under one roof.',
              },
              {
                icon: <Brain className="w-5 h-5 text-[#d4af37]" />,
                label: 'Production-Grade AI',
                body: 'Computer vision, NLP, predictive analytics, generative AI, and edge AI — deployed in real manufacturing environments, not just POCs.',
              },
              {
                icon: <Package className="w-5 h-5 text-[#d4af37]" />,
                label: 'Ready-to-Deploy Products',
                body: 'GateKeeper, VisionSafe AI, DigiTrack, PredictPulse, PermitFlows — purpose-built tools that go live in weeks, not months.',
              },
              {
                icon: <Cloud className="w-5 h-5 text-[#d4af37]" />,
                label: 'Multi-Platform Expertise',
                body: 'Official partners with Google Cloud, AWS, Microsoft Azure, IBM, and NVIDIA — plus deep expertise in SAP, Oracle, and Salesforce to integrate with your existing stack.',
              },
              {
                icon: <TrendingUp className="w-5 h-5 text-[#d4af37]" />,
                label: 'Outcome-Driven Results',
                body: 'Measurable gains in throughput, quality, uptime, cost, and compliance — backed by ISO 27001, ISO 9001 & SOC 2 Type II certifications.',
              },
            ].map((item, i) => (
              <motion.div
                key={i}
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.07 }}
                className="bg-[#1a1a1a] p-8 flex flex-col gap-4 hover:bg-[#1f1f1f] transition-colors duration-300 group"
              >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-14">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item}>
                    <Link to="/services" className="text-[#444] text-xs hover:text-[#a0a0a0] transition-colors">{item}</Link>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div>
              ...
              <a href="mailto:hello@virtechvisuals.com" className="text-[#444] text-xs hover:text-[#a0a0a0] transition-colors block">
                hello@virtechvisuals.com
              </a>
            </div>
          </div>
